...
axarr[0,0].plot(tt, sp_brx*np.ones(t.shape), 'r--', label='Brix setpoint')
...
ax_multistep.plot(tt, Fvin_t, 'g', label='Fvin') 
ax_multistep.legend(loc='best')
ax_multistep.grid()
ax_multistep.set_title('Multistep variable: Fvin')
ax_multistep.set(xlabel = 'Time [min]', ylabel = 'Fvin [m3/s]')
